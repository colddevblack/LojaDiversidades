...
using LojaDiversidade.IdentityServer.Configuration;
using LojaDiversidade.IdentityServer.Data;

namespace LojaDiversidade.IdentityServer.SeedDatabase;
    ...
    public void InitializeSeedDatabase()
    {
        ...
        if (_roleManager.FindByNameAsync(IdentityConfiguration.Admin).Result == null)
        {
            ...
            ApplicationUser admin = new ApplicationUser()
            {
                ...
                NormalizedUserName = "TESTE-ADMIN",
                Email = "teste_admin@com.br",
                NormalizedEmail = "TESTE_ADMIN@COM.BR",
                EmailConfirmed = true,
                LockoutEnabled = false,
                PhoneNumber = "+55 (11) 12345-6789",
                FirstName = "Teste",
        ...
        if (_roleManager.FindByNameAsync(IdentityConfiguration.Client).Result == null)
        {
            ...
            ApplicationUser client = new ApplicationUser()
            {
                ...
                NormalizedUserName = "TESTE-CLIENT",
                Email = "teste_client@com.br",
                NormalizedEmail = "TESTE_CLIENT@COM.BR",
                EmailConfirmed = true,
                LockoutEnabled = false,
                PhoneNumber = "+55 (11) 12345-6789",
                FirstName = "Teste",
