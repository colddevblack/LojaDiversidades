...
namespace LojaDiversidade.IdentityServer.Configuration;
...
public class IdentityConfiguration
{
    ...
    public static IEnumerable<ApiScope> ApiScopes =>
        new List<ApiScope>
        {
                // LojaDiversidade é aplicação web que vai acessar
                // o IdentityServer para obter o token
                new ApiScope("LojaDiversidade", "LojaDiversidade Server"),
    ...
    // Nossos clientes (LojaDiversidade.web) vão solitar um token ao IdentityServer
